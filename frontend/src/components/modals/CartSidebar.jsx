...
import { slideLeft } from "../../constants/utils/framer";
import { useDispatch, useSelector } from "react-redux";
import { RxCross1 } from "react-icons/rx";
import Image from "../common/Image";
import { offCartModal } from "../../features/modals/modalSlice";
      ...
      <div className="w-[90%] md:w-[450px] z-20 relative shadow-lg flex h-full bg-white flex-col gap-4">
        ...
        {cart?.length !== 0 ? (
          ...
          <div className="flex w-full h-full items-center justify-center flex-col gap-8">
            ...
            <h4 className="text-4xl family2 font-bold max-w-[300px] mx-auto text-center">Your cart is empty
            Shop now</h4>
          </div>
        )}
      </div>
